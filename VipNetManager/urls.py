"""
URL configuration for VipNetManager project.
...
admin.site.site_header = 'ИС "ViPNet Manager"'
admin.site.index_title = 'Панель администрирования'
admin.site.site_title = 'ViPNet Manager'

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', views.home, name='home'),
    path('Queue/', include('Queue.urls', 'Queue')),
